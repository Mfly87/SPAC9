...
class MySQLQueryGenerator():
    ...
    @staticmethod
    def drop_table_for_class(class_type: AbsSQLObj | type) -> str:
        _table_name = MySQLQueryGenerator._get_table_name(class_type)
        return "DROP TABLE IF EXISTS %s" % (_table_name)
    
    @staticmethod
    def generate_table_for_class(class_type: AbsSQLObj | type) -> str:
        _table_name = MySQLQueryGenerator._get_table_name(class_type)
    ...
    @staticmethod
    def generate_insert_query(class_type: AbsSQLObj | type) -> str:
        _table_name = MySQLQueryGenerator._get_table_name(class_type)
    ...
    @staticmethod
    def generate_insert_many_query(class_type: AbsSQLObj | type) -> str:
        _table_name = MySQLQueryGenerator._get_table_name(class_type)
        _column_names = MySQLQueryGenerator._get_column_names(class_type)
    ...
    @staticmethod
    def generate_search_query(class_type: AbsSQLObj | type, *, search_term: str = "", output_rows: str = "*") -> str:
        _table_name = MySQLQueryGenerator._get_table_name(class_type)
        _query = "SELECT %s FROM %s %s" % (output_rows, _table_name, search_term)
        return _query.strip()
    
    @staticmethod
    def generate_update_query(unique_data: AbsSQLObj) -> str:
    ...
    @staticmethod
    def _get_column_values(unique_data: AbsSQLObj):
        _values = MySQLQueryGenerator._get_values(unique_data)
        return ", ".join(_values)
    
    @staticmethod
    def _unique_data_update_values(unique_data: AbsSQLObj):
    ...
    @staticmethod
    def _sql_value_list(unique_data: AbsSQLObj) -> list[str]:
        _string_values = []
    ...
    @staticmethod
    def _get_sql_data_type_list(class_type: AbsSQLObj | type) -> str:
    ...
    @staticmethod
    def _get_table_name(class_type: type | AbsSQLObj) -> str:
    ...
    @staticmethod
    def _get_column_names(class_type: AbsSQLObj):
        _headers = MySQLQueryGenerator._get_headers(class_type)
        return ', '.join(_headers)
        
    @staticmethod
    def _get_column_symbols(class_type: AbsSQLObj):
        _headers = MySQLQueryGenerator._get_headers(class_type)
    ...
    @staticmethod
    def _get_column_definitions(class_type: AbsSQLObj) -> str:
    ...
    @staticmethod
    def _get_sql_definition_list(class_type: AbsSQLObj) -> str:
        _headers = MySQLQueryGenerator._get_headers(class_type)
    ...
    @staticmethod
    def _get_headers(class_type: AbsSQLObj):
        return class_type.get_build_headers(class_type)[1:]
    
    @staticmethod
    def _get_types(class_type: AbsSQLObj):
        return class_type.get_build_types(class_type)[1:]
    
    @staticmethod
    def _get_values(abs_obj: AbsSQLObj):
